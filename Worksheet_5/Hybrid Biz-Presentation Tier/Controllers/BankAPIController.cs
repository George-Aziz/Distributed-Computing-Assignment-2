...
namespace Hybrid_Biz_Presentation_Tier.Controllers
{
    public class BankAPIController : ApiController
    {
        ...
        {
            //Encodes both first and last name to prevent any XSS Attack from happening
            AntiXssEncoder.HtmlEncode(fName, true);
            AntiXssEncoder.HtmlEncode(lName, true);
        ...
        {
            AntiXssEncoder.HtmlEncode(_userID, true);
        ...
        {
            AntiXssEncoder.HtmlEncode(_accID, true);
        ...
        {
            AntiXssEncoder.HtmlEncode(_accID, true);
            AntiXssEncoder.HtmlEncode(_amt, true);
        ...
        {
            AntiXssEncoder.HtmlEncode(_senderID, true);
            AntiXssEncoder.HtmlEncode(_receiverID, true);
            AntiXssEncoder.HtmlEncode(_amt, true);
